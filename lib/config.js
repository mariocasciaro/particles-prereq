...
var self = module.exports = {
  ...
  _persist: function(key, val, file, callback) {
    ...
    file = path.join(self.get('configDir'), file);
  ...
  initialize: function(init) {
    ...
    var configDir = self.getRaw('configDir') || path.join(appRoot, "config");
    ...
    var genDefaults = path.join(configDir, 'defaults.gen.json');
    ...
    var overrides = path.join(configDir, 'overrides.gen.json');
